...
export class CreateAccountComponent {
  ...
  onSubmit() {
    ...
    console.log(`customerId: ${accountid}, Number: ${this.number}, Choice: ${this.choice}`);
    const obj= new CustomerAccount(0, accountid,this.number,'No',new Date(),this.choice==='CA'?AccountType.CA: AccountType.SB)
    console.log("obj: ", obj)
    this.dataService.postAccount(obj).subscribe((result) => {
      this.changeSelectedValue.emit('this is Account List');
    });
  }
}
